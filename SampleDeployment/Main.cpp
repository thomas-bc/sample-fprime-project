...
#include <SampleDeployment/Top/SampleDeploymentTopology.hpp>
...
static void signalHandler(int signum) {
    SampleDeployment::stopSimulatedCycle();
}
...
int main(int argc, char* argv[]) {
    ...
    SampleDeployment::TopologyState inputs;
    ...
    SampleDeployment::setupTopology(inputs);
    SampleDeployment::startSimulatedCycle(1000);  // Program loop cycling rate groups at 1Hz
    SampleDeployment::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
