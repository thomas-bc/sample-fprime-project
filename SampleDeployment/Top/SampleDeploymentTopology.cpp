// ======================================================================
// \title  SampleDeploymentTopology.cpp
// \brief cpp file containing the topology instantiation code
//
// ======================================================================
// Provides access to autocoded functions
#include <SampleDeployment/Top/SampleDeploymentTopologyAc.hpp>
#include <SampleDeployment/Top/SampleDeploymentPacketsAc.hpp>
...
void configureTopology() {
    ...
    //tlmSend.setPacketList(SampleDeploymentPacketsPkts, SampleDeploymentPacketsIgnore, 1);
}

// Public functions for use in main program are namespaced with deployment name SampleDeployment
...
void startSimulatedCycle(U32 milliseconds) {
    ...
    // Main loop
    while (cycling) {
        SampleDeployment::blockDrv.callIsr();
