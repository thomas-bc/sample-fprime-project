// ======================================================================
// \title  SampleDeploymentTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef SAMPLEDEPLOYMENT_SAMPLEDEPLOYMENTTOPOLOGY_HPP
#define SAMPLEDEPLOYMENT_SAMPLEDEPLOYMENTTOPOLOGY_HPP
// Included for access to SampleDeployment::TopologyState and SampleDeployment::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <SampleDeployment/Top/SampleDeploymentTopologyDefs.hpp>

// Remove unnecessary SampleDeployment:: qualifications
using namespace SampleDeployment;
 ...
 * SampleDeployment::TopologyState see: SampleDeploymentTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type SampleDeployment::TopologyState see: SampleDeploymentTopologyDefs.hpp.
 *
